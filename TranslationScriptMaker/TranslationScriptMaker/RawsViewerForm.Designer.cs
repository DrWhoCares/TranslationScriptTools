namespace TranslationScriptMaker
{
	partial class RawsViewerForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.RawsPictureBox = new System.Windows.Forms.PictureBox();
			...
			// RawsViewerPanel
			// 
			this.RawsViewerPanel.Controls.Add(this.RawsViewerGroupBox);
			...
			// RawsViewerGroupBox
			// 
			this.RawsViewerGroupBox.Controls.Add(this.RawsPictureBox);
			...
			((System.ComponentModel.ISupportInitialize)(this.RawsPictureBox)).EndInit();
		...
		private System.Windows.Forms.PictureBox RawsPictureBox;
